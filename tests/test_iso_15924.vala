...
namespace libisocodes {
    public class Test_ISO_15924 : Object
    {
        ...
        {
            Test.add_func("/iso_15924/create class", () => {
                var i = new ISO_15924();
                assert(i != null);
                assert(i.standard == "15924");
                assert(i.get_filepath() == "/usr/share/xml/iso-codes/iso_15924.xml");
            });
            Test.add_func("/iso_15924/create class with changed filepath", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                assert(i.get_filepath() == Config.TESTDIR + "/iso_15924.xml");
                assert(i.standard == "15924");
                try {
            ...
            Test.add_func("/iso_15924/find all codes", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
                    var e = i.find_all();
            ...
            Test.add_func("/iso_15924/find all codes in locale 'fr'", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
                    i.set_locale("fr");
            ...
            Test.add_func("/iso_15924/call find_code() without argument", () => {
                var i = new ISO_15924();
                try {
                    var e = i.find_code();
            ...
            Test.add_func("/iso_15924/search empty code", () => {
                var i = new ISO_15924();
                try {
                    var e = i.find_code("");
                    // This assert is just to use the variable e,
            ...
            Test.add_func("/iso_15924/find code 'Cyrl'", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
            ...
            Test.add_func("/iso_15924/find code '200'", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
            ...
            Test.add_func("/iso_15924/find code 'BENG'", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
            ...
            Test.add_func("/iso_15924/find code 'grEK'", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
            ...
            Test.add_func("/iso_15924/search non existant code", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
            ...
            Test.add_func("/iso_15924/find code 'Grek' in locale 'de'", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
                    i.set_locale("de");
            ...
            Test.add_func("/iso_15924/find code '220' in locale 'fr'", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
                    i.set_locale("fr");
            ...
            Test.add_func("/iso_15924/find code 'Latn' in non existant locale", () => {
                var i = new ISO_15924();
                i.set_filepath(Config.TESTDIR + "/iso_15924.xml");
                try {
